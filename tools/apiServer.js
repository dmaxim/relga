...
function validateApplication(application) {
  if (!application.name) return 'Name is required.';
  if (!application.description) return 'Description is required.';
  if (!application.applicationTypeId) return 'Application Type is required.';
  return '';
}
